...
- **AI 기반 검색**: GPT를 활용한 맥락적 용어 선별 및 검색 이유 제공
...
```
자연어 질의 → Phase 1 → Phase 2&3 → Phase 4 → 용어 검색
              전처리     하이브리드    AI 재순위
                        검색         & 설명
```
...
- **`ai_reranker.py`**: Phase 4 - GPT 기반 최종 후보 선별 및 검색 이유 생성
...
1위. 개인정보보호
    ...
    매칭 키워드: 정보, 보호
    AI 결과 근거: 고객 정보 보안 저장의 핵심 개념으로 가장 적합

2위. 데이터암호화
    설명: 데이터를 암호화하여 보안을 강화하는 기술
    점수: 0.823 (의미: 0.756, 키워드: 0.923)
    매칭 키워드: 데이터, 보안
    AI 결과 근거: 안전한 저장을 위한 구체적인 기술적 방법
```
...
- **예시**: 
  - ✅ 가능: "직원 정보 관리" → "직원정보", "사원번호", "인사관리" 등 용어 검색 결과 제공
...
현재 용어 감섹 시스템을 기반으로 실시간 데이터베이스 조회 시스템으로 확장 예정:
